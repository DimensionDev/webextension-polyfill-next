...
export const ThisSideImplementation: FrameworkMayInvokeMethods | null =
    typeof importScripts === 'function' ? null : createLocalImpl()
export const FrameworkRPC =
    typeof importScripts === 'function'
        ? null!
        : AsyncCall<FrameworkImplementation>(ThisSideImplementation, {
              log: false,
